<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/WebBackstage.master" AutoEventWireup="true" CodeFile="WebArticles_Draft.aspx.cs" Inherits="WebArticles_Draft" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    ...
    <div class="row">
        当前位置：<a href="#">文章管理</a>>><a href="#">草稿箱</a>
                    ...
                    <div class="widget">
                        ...
                        <div class="widget-body">
                            ...
                            <div class=" col-xs-10 col-md-10">
                                ...
                                <asp:Button ID="UpdateBtn" runat="server" Text="编辑" class="btn btn-info"
                                    OnClick="UpdateBtn_Click" />&nbsp;&nbsp;&nbsp;&nbsp;
                                   
                                
                                <asp:Button ID="DelBtn" runat="server" Text="删除" class="btn btn-warning"
